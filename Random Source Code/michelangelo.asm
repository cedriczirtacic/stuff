;From netcom.com!filbert Mon Jan  2 09:42:43 1995
;Xref: netcom.com alt.comp.virus.source.code:1
;Newsgroups: alt.comp.virus.source.code
;Path: netcom.com!filbert
;From: filbert@netcom.com (Jon Furry)
;Subject: michelangelo_virus.asm
;Message-ID: <filbertD1rB2w.ALq@netcom.com>
;Organization: NETCOM On-line Communication Services (408 261-4700 guest)
;X-Newsreader: TIN [version 1.2 PL1]
;Date: Mon, 2 Jan 1995 02:32:56 GMT
;Lines: 259

;available with others from: ftp.netcom.com /pub/fi/filbert/Virus
;--------------------------------------------------------------------------
...
;   f i l b e r t @ n e t c o m  . c o  m  - p h r u w t   e - z i n e 
;   f t p : f t p . n e t c o m . c o m  / p u b / f i / f i l b e r t 
;   m a c i n t o s h  a n d  d o s  v i r u s  /  s o u r c e s / : )
;   __________________________________________________________________
;
